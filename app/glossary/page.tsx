...
export default function GlossaryPage() {
  ...
  const faqs = t('glossaryPage.faqs', { returnObjects: true, defaultValue: defaultFaqs }) as typeof defaultFaqs
    ...
    <div className="container py-24 mx-auto max-w-4xl px-4">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-primary to-cyan-500 bg-clip-text text-transparent">
          {t('glossaryPage.title', "Web Development Glossary")}
        </h1>
        <p className="text-muted-foreground text-lg">
          {t('glossaryPage.subtitle', "Clear answers to complex technical questions.")}
        </p>
      </div>
