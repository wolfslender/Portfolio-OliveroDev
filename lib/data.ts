...
export const services = [
  ...
  {
    title: "MVP Launchpad",
    description: "High-speed market entry for visionaries. We build robust, scalable MVPs using WordPress, Webflow, or Next.js to test your hypothesis in weeks, not months.",
    icon: Layout,
    features: ["Rapid Prototyping", "Full CMS Control", "Conversion-Ready Design", "Scalable Foundations"],
    technologies: ["WordPress", "CSS", "JS", "PHP"],
  ...
  {
    title: "Migración a Webflow",
    description: "Mueve tu sitio de marketing a Webflow para total libertad de diseño y hosting sin mantenimiento. Perfecto para equipos de marketing.",
    icon: Rocket,
    features: ["Diseño Pixel-Perfect", "Arquitectura CMS", "Migración SEO", "Entrenamiento del Equipo"],
    technologies: ["Webflow", "WordPress", "React", "Node.js"],
    caseStudyTitle: "CST Puerto Rico Website",
    color: "text-emerald-500",
    bgColor: "bg-emerald-500/10",
  },
  {
    title: "Partnership Técnico",
    description: "Un retainer mensual para empresas que necesitan un socio nivel CTO dedicado sin el costo de un salario a tiempo completo.",
    icon: Users,
    features: ["Soporte Prioritario", "Auditorías Mensuales", "Desarrollo de Features", "Consultoría Estratégica"],
    technologies: ["React", "Next.js", "Cloud Architecture", "Agile"],
    caseStudyTitle: "GovValue",
