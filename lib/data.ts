...
export const services = [
  {
    title: "Websites & MVPs",
    description: "A working website or MVP in weeks — not months. Strategy, UX, and build all in one package. Includes Webflow migrations if you're tired of WordPress.",
    icon: Layout,
    features: ["Rapid Prototyping", "Conversion-Focused UX", "CMS or App Build", "Launch Strategy", "Webflow Migrations"],
    technologies: ["Next.js", "React", "WordPress", "Webflow", "Supabase"],
  ...
  },
  {
    ...
    description: "Your site is slow, outdated, or a pain to maintain. I clean it up, speed it up, lock down security, and can stay on as your technical partner. No handoffs, no ghosting.",
    icon: Code2,
    features: ["Code Audit & Refactor", "Performance Tuning", "Security Hardening", "Ongoing Retainer", "Infrastructure"],
    technologies: ["WordPress", "Next.js", "Azure", "AWS", "Docker", "PHP", "SEO"],
    ...
    timeline: "3-8 weeks (ongoing retainer available)",
    outcome: "A faster, safer, more maintainable platform — with a partner who stays on your team.",
    deliverables: ["Technical Audit", "Priority Fix Roadmap", "Refactor & Optimization", "Retainer Support"],
    startingPrice: "$3K",
  },
  {
