  ...
  const shareLinks = [
    {
      ...
      className: "bg-transparent border-2 border-[#25D366] text-[#25D366] hover:bg-[#25D366] hover:text-white hover:border-[#25D366]",
    },
    {
      name: "Facebook",
      icon: <Facebook className="w-5 h-5" />,
      href: `https://www.facebook.com/sharer/sharer.php?u=${encodedUrl}`,
      className: "bg-transparent border-2 border-[#1877F2] text-[#1877F2] hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2]",
    },
    {
      name: "Messenger",
      icon: (
      ...
      className: "bg-transparent border-2 border-[#00B2FF] text-[#00B2FF] hover:bg-[#00B2FF] hover:text-white hover:border-[#00B2FF]",
    },
    {
      name: "LinkedIn",
      icon: <Linkedin className="w-5 h-5" />,
      href: `https://www.linkedin.com/sharing/share-offsite/?url=${encodedUrl}`,
      className: "bg-transparent border-2 border-[#0A66C2] text-[#0A66C2] hover:bg-[#0A66C2] hover:text-white hover:border-[#0A66C2]",
    },
    {
      name: "Reddit",
      icon: (
      ...
      className: "bg-transparent border-2 border-[#FF4500] text-[#FF4500] hover:bg-[#FF4500] hover:text-white hover:border-[#FF4500]",
    },
    {
      name: "X (Twitter)",
      icon: (
      ...
      className: "bg-transparent border-2 border-black text-black hover:bg-black hover:text-white hover:border-black dark:border-white dark:text-white dark:hover:bg-white dark:hover:text-black dark:hover:border-white",
    },
    {
      name: "Email",
      icon: <Mail className="w-5 h-5" />,
      href: `mailto:?subject=${encodedTitle}&body=${encodedUrl}`,
      className: "bg-transparent border-2 border-gray-500 text-gray-500 hover:bg-gray-500 hover:text-white hover:border-gray-500",
    },
  ]
