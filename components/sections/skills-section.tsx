...
export function SkillsSection() {
  ...
  const outcomeCategories = [
    {
      title: t('skillsSection.categories.0.title'),
      icon: Zap,
      outcome: t('skillsSection.categories.0.outcome'),
      impact: t('skillsSection.categories.0.impact'),
    ...
    {
      title: t('skillsSection.categories.1.title'),
      icon: TrendingUp,
      outcome: t('skillsSection.categories.1.outcome'),
      impact: t('skillsSection.categories.1.impact'),
    ...
    {
      title: t('skillsSection.categories.2.title'),
      icon: Shield,
      outcome: t('skillsSection.categories.2.outcome'),
      impact: t('skillsSection.categories.2.impact'),
    ...
    {
      title: t('skillsSection.categories.3.title'),
      icon: Globe,
      outcome: t('skillsSection.categories.3.outcome'),
      impact: t('skillsSection.categories.3.impact'),
    ...
    {
      title: t('skillsSection.categories.4.title'),
      icon: Users,
      outcome: t('skillsSection.categories.4.outcome'),
      impact: t('skillsSection.categories.4.impact'),
    ...
    {
      title: t('skillsSection.categories.5.title'),
      icon: Award,
      outcome: t('skillsSection.categories.5.outcome'),
      impact: t('skillsSection.categories.5.impact'),
        ...
        <ScrollReveal>
          <div className="text-center mb-20">
            <h2 className="text-4xl sm:text-6xl font-black mb-6 tracking-tight">
              ...
              <span className="text-primary">{t('skillsSection.titleHighlight')}</span>
            </h2>
                ...
                <div className={`group relative p-8 bg-card rounded-3xl border-2 ${category.borderColor} hover:border-primary/40 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5 h-full`}>
                  ...
                  <div className="relative">
                    ...
                    <div className="mb-6 p-5 bg-gradient-to-br from-primary/5 to-transparent rounded-2xl border-l-4 border-primary">
                      <p className="text-xs font-bold uppercase tracking-widest text-primary mb-2">{t('skillsSection.whatThisMeans')}</p>
          ...
          <div className="relative p-12 bg-gradient-to-br from-slate-950 to-slate-900 rounded-[3rem] border border-white/5 overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="text-center mb-10">
                <h3 className="text-3xl font-black text-white mb-3">{t('skillsSection.fullTechStack')}</h3>
                <p className="text-slate-400 text-lg">{t('skillsSection.everythingUse')}</p>
              </div>
